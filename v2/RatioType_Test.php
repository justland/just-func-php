...
class RatioType_Test extends InterpreterTestCase
{
  ...
  {
    $ratio = new RatioType();
    $this->assertTrue($ratio->is(['ratio', 1]));
    $this->assertFalse($ratio->is(0));
    $this->assertFalse($ratio->is(1.0));
    $this->assertFalse($ratio->is(null));
    $this->assertFalse($ratio->is(true));
    $this->assertFalse($ratio->is('1'));
  }
